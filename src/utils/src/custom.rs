...
//     pub fn remove_first_detail(&mut self) {
...
//     pub fn set_square_url(&mut self, s_url: URL) -> &Self {
//         self.square_url = s_url;
//         self
//     }
...
// pub fn info(page: usize, num_of_page: Option<usize>) -> (i32, Vec<GameInfo>) {
//     assert!(page > 0);
...
// pub fn remove_first_detail(id: String) {
//     GAMES.with(|games|
//         games
//             .borrow_mut()
//             .iter_mut()
//             .find(|game| id == game.id)
//             .map(|game| game.remove_first_detail())
//     );
// }
...
// pub fn set_square_url(id: String, url: URL) -> Option<GameInfo> {
//     GAMES.with(|games| {
//         games
//             .borrow_mut()
//             .iter_mut()
//             .filter(|game| id == game.id)
//             .map(|game| game.set_square_url(url.clone()))
//             .cloned()
//             .nth(0)
//     })
// }