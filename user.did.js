export const idlFactory = ({ IDL }) => {
  ...
  const SuccessResult_4 = IDL.Record({ 'followers' : IDL.Nat64 });
  const Response_8 = IDL.Variant({ 'Success' : SuccessResult_4 });
  const SuccessResult_5 = IDL.Record({ 'followings' : IDL.Nat64 });
  const Response_9 = IDL.Variant({ 'Success' : SuccessResult_5 });
  const SuccessResult_6 = IDL.Record({ 'question' : Question });
  const Response_10 = IDL.Variant({ 'Success' : SuccessResult_6 });
  const SuccessResult_7 = IDL.Record({ 'votes' : IDL.Nat32 });
  ...
  const SuccessResult_8 = IDL.Record({ 'profile' : Profile });
  const Response_12 = IDL.Variant({ 'Success' : SuccessResult_8 });
  const Args_9 = IDL.Record({ 'owner' : IDL.Principal });
  const SuccessResult_9 = IDL.Record({ 'principal' : IDL.Principal });
  ...
  const Args_11 = IDL.Record({ 'question_id' : IDL.Text });
  const Response_16 = IDL.Variant({
    'Success' : IDL.Null,
    'UpVoteInvalid' : IDL.Null,
  });
  const Args_12 = IDL.Record({ 'owner' : IDL.Principal, 'name' : IDL.Text });
  ...
  const Args_17 = IDL.Record({ 'tvl' : IDL.Nat32, 'owner' : IDL.Principal });
  ...
  const SuccessResult_10 = IDL.Record({
    'question_list' : IDL.Tuple(IDL.Int32, IDL.Vec(Question)),
  });
  const Response_20 = IDL.Variant({ 'Success' : SuccessResult_10 });
  return IDL.Service({
    ...
    'get_profile_followers_count' : IDL.Func([Args_7], [Response_8], ['query']),
    'get_profile_followings_count' : IDL.Func(
        [Args_7],
        [Response_9],
        ['query'],
      ),
    'get_question_by_id' : IDL.Func([Args_4], [Response_10], ['query']),
    'get_question_votes_by_id' : IDL.Func([Args_4], [Response_11], ['query']),
    'get_user_profile' : IDL.Func([Args_8], [Response_12], ['query']),
    'init_state' : IDL.Func([Args_9], [Response_13], ['query']),
    'set_user_principal' : IDL.Func([Args_9], [Response_14], []),
    'set_user_profile' : IDL.Func([Args_10], [Response_15], []),
    'un_follow_operation' : IDL.Func([Args_5], [Response_3], []),
    'up_vote' : IDL.Func([Args_11], [Response_16], []),
    'update_name' : IDL.Func([Args_12], [Response_17], []),
    'update_profile_description' : IDL.Func([Args_13], [Response_18], []),
    'update_user_holders' : IDL.Func([Args_14], [Response_19], []),
    'update_user_holding' : IDL.Func([Args_15], [Response_17], []),
    'update_user_tickets' : IDL.Func([Args_16], [Response_17], []),
    'update_user_tvl' : IDL.Func([Args_17], [Response_17], []),
    'update_username' : IDL.Func([Args_18], [Response_17], []),
    'view_by_page' : IDL.Func([Args_19], [Response_20], ['query']),
  });
};
